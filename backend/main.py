...
[전문가 패널 구성]
1. UA 및 브랜딩 마케터 전문가: CPI 적정성, 모객 효율, UA 전략, CAC/LTV 분석, Organic Boost 평가
...
- 모객 효율 및 UA 전략 (CPI {summary.get('cpi', 'N/A')}원 기준)
...
3. 통합 신뢰도 평가: NRU/CPI 목표 현실성, 표본 데이터 품질, 시장 벤치마크 적정성, 수익 예측 현실성을 하나의 통합된 문단으로 분석
